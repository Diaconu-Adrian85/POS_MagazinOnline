...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle">Creaza un cont nou</h4>
	<p class="text title-tag-line">Creaza un cont de comanda</p>
	<form class="register-form outer-top-xs" role="form" method="post" name="register" onSubmit="return valid();">
<div class="form-group">
	    	<label class="info-title" for="fullname">Nume intreg<span>*</span></label>
...
<div class="form-group">
	    	<label class="info-title" for="contactno">Date contact <span>*</span></label>
	    	<input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" maxlength="10" required >
	  	</div>

<div class="form-group">
	    	<label class="info-title" for="password">Parola cont <span>*</span></label>
...
<div class="form-group">
	  	...
	  	<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button" id="submit">Inregistrare noua</button>
	</form>
