...
header('location:.php');
	...
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Adresa FACTURARE has been updated');</script>";
		}
	}
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button">Actualizează</button>
					</form>
					<?php } ?>
				</div>	
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button">Actualizează</button>
					</form>
					<?php } ?>
